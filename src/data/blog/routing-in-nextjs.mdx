...
Now, if you visit _/products/100_, the _params.productId_ will be _100_, and it will render dynamically.
...
- _/categories/electronics_
- _/categories/fashion_
- _/categories/electronics/phones_
- _/categories/fashion/shoes_
...
- _/docs_
- _/docs/getting-started_
- _/docs/api/reference_
